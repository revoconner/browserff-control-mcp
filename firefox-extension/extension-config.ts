...
export const AVAILABLE_TOOLS: ToolInfo[] = [
  ...
  },
  {
    id: "click-element",
    name: "Click Element",
    description: "Allows the MCP server to click on elements in web pages"
  },
  {
    id: "fill-form-field",
    name: "Fill Form Field",
    description: "Allows the MCP server to fill out form fields in web pages"
  },
  {
    id: "execute-javascript",
    name: "Execute JavaScript",
    description: "Allows the MCP server to execute arbitrary JavaScript code on web pages"
  },
  {
    id: "monitor-page-changes",
    name: "Monitor Page Changes",
    description: "Allows the MCP server to monitor DOM changes on web pages"
  },
  {
    id: "screenshot-website",
    name: "Screenshot Website",
    description: "Allows the MCP server to take screenshots of web pages"
  },
  {
    id: "search-bookmarks",
    name: "Search Bookmarks",
    description: "Allows the MCP server to search browser bookmarks"
  },
  {
    id: "open-bookmark",
    name: "Open Bookmark",
    description: "Allows the MCP server to open bookmarks in new tabs"
  }
];
...
export const COMMAND_TO_TOOL_ID: Record<ServerMessageRequest["cmd"], string> = {
  ...
  "monitor-page-changes": "monitor-page-changes",
